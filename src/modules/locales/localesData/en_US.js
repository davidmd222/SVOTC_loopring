...
export default {
  ...
  place_order_by_loopr: {
    title: 'Place Order By SVOTC Wallet',
    step_qrcode: 'Scan QRcode with SVOTC',
    step_sign: 'Sign Order On SVOTC',
    step_result: 'Result',
    qrcode_overdue: 'QRcode is overdue, please place order again',
    instruction_download: 'Download SVOTC-IOS',
    instruction_scan: 'Open your SVOTC wallet, scan the QRcode and submit',
    ...
    waiting_sign: 'Waiting for your operations on SVOTC Wallet to sign and submit',
  },
  ...
  unlock_by_loopr: {
    instruction_download: 'Download SVOTC-IOS',
    instruction_scan: 'Open your SVOTC wallet，scan the QRcode and confirm',
  ...
  loopr_sign:{
    ...
    tips:{
      download:'Download SVOTC-IOS',
      scan: 'Open your SVOTC wallet, scan the QRcode and submit',
