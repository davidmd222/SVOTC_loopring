...
class Unlock extends React.Component {
  ...
  civicIntegration () {
    console.log(this);
    var _self = this;
    var civic = window.civic;
    var civicSip = new civic.sip({ appId: 'sDO3GOVPW' });
    ...
    if (button) {
        ...
        civicSip.on('auth-code-received', function(event) {
            ...
            //     var civicClient1 = civicSip1.newClient({
            //       appId: 'sDO3GOVPW',
            //       prvKey: 'd283105003b67011fc1c115ae79961f5a08cfaf00556e13f2fc33c5816c7e0a7',
            //       appSecret: 'affca4a655e666e0609f87cfcd3c32ef',
            //     });
            //     civicClient1.exchangeCode(jwtToken)
            //     .then((userData) => {
    ...
    console.log(typeof(tokenBro));
    if(this.state.foo === 'sarma') {
      console.log('Jeste')
      return (
        ...
        <div className="body home">
          <div className="home-content open">
            <div>
                <button id="signupButton" style={{ 'background-color': "green" }}  class="civic-button-a medium" onClick={() => this.civicIntegration()} type="button">
